...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            <?php
            $homeSettings    = get_option('cUsMC_HOME_settings');
            ?>
            <form name="page-form-home" id="page-form-home">
                ...
                <input type="hidden" name="action" value="cUsMC_setPageSettingsHome">
            </form>
        </tr>
        <!-- FORM TR END -->
    ...
    <?php
        ...
        if (is_array($mypages)) {
            foreach ($mypages as $page) {
                $pageSettings = get_post_meta($page->ID, 'cUsMC_FormByPage_settings', true);
                ?>
                ...
                <tr class="form_placement_item">
                    ...
                    <form name="page-form-<?php echo $page->ID; ?>" id="page-form-<?php echo $page->ID; ?>">
                        ...
                        <td>
                            ...
                            <select class="form-control form_key_byPage" name="form-key" data-pageid="<?php echo $page->ID; ?>">
                                ...
                                if ($cUsMC_API_getFormKeys) {
                                    ...
                                    update_option('cUsMC_settings_form_thumbs', $aryFormThumbs );//UPDATE FORM SETTINGS
                                }
                                ?>
                            </select>
                            <script>
                        ...
                        <input type="hidden" name="action" value="cUsMC_setPageSettings">
...
<script>
    ...
    cUsMC_myjq(document).ready(function($) {
        ...
        $('.form_key_byPage').change(function(){
            ...
            var oFormData = 'action=cUsMC_setFormKeyByPage';
