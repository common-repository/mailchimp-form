...
<div id="sidebar-cta" class="text-center">
    ...
    <a href="<?php echo cUsMC_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($upgrade)); ?>" target="_blank" class="btn btn-success btn-block">Get Started with an Upgrade Account</a>
        <hr/>
